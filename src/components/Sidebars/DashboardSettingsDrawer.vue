	...
	>
		...
		<div class="drawer-content">
			...
			<div class="github-stars">
				<gh-btns-star slug="extvos/quickstart" show-count></gh-btns-star>
			</div>
			<div class="download">
				<a-button type="dark" href="https://github.com/extvos/quickstart" block target="_blank">Source Code</a-button>
			</div>
		</div>
		<!-- / Settings Drawer Content -->
